...
export default {
  ...
  methods: {
    ...
    handlepublic(row) {
      ...
      axios
        .post("http://localhost:8080/videos/updatepublic", params, {
          headers: {
            token: this.token,
          },
        })
    ...
    handleprivate(row) {
      ...
      params.append("id", row.id);
      axios
        .post("http://localhost:8080/videos/updateprivate", params, {
          headers: {
            token: this.token,
          },
        })
    ...
    onSubmit() {
      ...
      //分页查询
      axios
        .get("http://localhost:8080/videoscheck", {
          params: {
